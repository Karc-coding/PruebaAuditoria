...
import com.example.auditoria.apigateway.dto.RequestDto;
import com.example.auditoria.apigateway.dto.TokenDto;
    ...
    public GatewayFilter apply(Config config) {
        return (((exchange, chain) -> {
            ...
            return webClient.build()
                    .post()
                    .uri("http://security/api/v1/autenticacion/validar?token=" + chunks[1])
